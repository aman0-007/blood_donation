...
class Hospitalactivesessions extends StatefulWidget {
  const Hospitalactivesessions({super.key});

  @override
  State<Hospitalactivesessions> createState() => _HospitalactivesessionsState();
}

class _HospitalactivesessionsState extends State<Hospitalactivesessions> {
  String searchQuery = '';
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Takeblood(sessionName: sessionName),
                          ),
                        );
                      },
                    ),
